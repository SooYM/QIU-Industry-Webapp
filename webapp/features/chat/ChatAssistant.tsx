...
import { answerFromJobs, withAiWarning } from "../../app/chat";
...
export function ChatAssistant({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: "assistant", content: withAiWarning("Ask me to compare jobs, find internships, or explain a listed company profile. I only use the supplied vacancy records.") },
  ]);
